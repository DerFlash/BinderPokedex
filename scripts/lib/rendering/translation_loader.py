...
class TranslationLoader:
    ...
    def _get_translations_path(cls) -> Path:
        ...
        if cls._translations_path is None:
            ...
            # Navigate: translation_loader.py -> rendering/ -> lib/ -> scripts/ -> root/
            # Path: ...BinderPokedex/scripts/lib/rendering/translation_loader.py
            # Need to go up 4 levels to root, then into i18n/
            cls._translations_path = loader_file.parent.parent.parent.parent / 'i18n' / 'translations.json'
