...
| `PA-013` | Multiple posters can be assigned to aggregate sections | Open | Define a poster-list schema and insert one poster after each configured section cover |
