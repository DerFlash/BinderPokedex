...
| --- | --- | --- | --- | --- | --- |
| FLUX.2 Spatial+Identity v5 `joint_scene` | Yes | Gen VII `00018`, Gen I `00001`, Base1 `00001`, ExGen3 Mega `00001`, and ExGen3 Normal `00001` pass the accepted print-detail tolerance | All five promotions pass their physical crops with preferred fill | Coherent grounding and shadows; natural foreground crossings remain unproven | Default; five scopes promoted |
| Two-pass `identity_lock` | No | Exact source pixels | Reliable | Protected lower band can read as a layer | Explicit fallback; eight promoted scopes remain valid |
...
| `PA-017` | Joint generation can provide natural grounding without losing identity or card safety | Done for five reviewed scopes; rollout ongoing | Gen VII `00018`, Gen I `00001`, Base1 `00001`, ExGen3 Mega `00001`, and ExGen3 Normal `00001` are promoted; each additional scope must pass independently |
...
- Generation VII `00018`, Generation I `00001`, Base1 `00001`, ExGen3 Mega
  `00001`, and ExGen3 Normal `00001` are the five promoted `joint_scene`
  bundles.
- The other eight bundles remain accepted `identity_lock` fallbacks until
