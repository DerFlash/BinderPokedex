...
- `SV03.5`: Bulbasaur, Charmander, and Squirtle in a Kanto coastal meadow for
  Scarlet & Violet - 151.
- `Pokedex/sections/gen1` through `gen8`: each generation's three starters in
...
Base1, SV03.5, Pokédex Generations I through VIII, and both ExGen3 sections have
...
routing. Generations I through VIII are accepted and enabled; Generation IX
remains the staged rollout in
